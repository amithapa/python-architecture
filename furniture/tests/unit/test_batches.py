...
def test_allocating_to_a_batch_reduces_the_availabilty_quantity():
...
def test_cannot_allocate_if_smaller_than_required():
    small_batch, large_line = make_batch_and_line("SMALL-TABLE", 10, 12)
